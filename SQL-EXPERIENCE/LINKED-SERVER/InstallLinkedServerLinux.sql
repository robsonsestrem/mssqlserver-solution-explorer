/*
 *
	OBJETIVO: Documentação do processo de instalação e configuração do Microsoft ODBC Driver
			  para SQL Server em ambiente Linux (CentOS/RHEL), incluindo procedimentos
			  para instalação, verificação e desinstalação, além de referências para
			  criação de Linked Servers e resolução de erros comuns.
