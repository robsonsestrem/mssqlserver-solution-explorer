/*
    OBJETIVO: Verificar o espaço disponível em disco para todos os volumes
              que armazenam arquivos de dados e logs do SQL Server,
              exibindo tamanho total e espaço livre em GB.
