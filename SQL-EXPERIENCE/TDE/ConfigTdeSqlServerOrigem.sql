...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Passos para ativa��o da TDE em uma base de dados
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- VISUALIZAR ANDAMENTO DO SCAN POR ALTERA��ES EM UMA BASE COM "SET ENCRYPTION ON|OFF"
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT 
    A.[name], 
...
-- Caso tenha alterado a base "SET ENCRYPTION ON|OFF", vai ter que esperar o scan e leva em m�dia 2 horas.
...
-- Se voc� verificar a vincula��o do certificado agora, ver� que a DEK agora est� vinculada ao novo certificado.
USE [master]
GO
SELECT
...
insert into @logs
exec sp_readerrorlog; -- fun��o interna
