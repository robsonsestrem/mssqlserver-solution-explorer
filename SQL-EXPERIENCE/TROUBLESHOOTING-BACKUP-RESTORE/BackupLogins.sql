...
-- O result da consulta em cima das procedures é para rodar a criação dos logins na outra instância
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
USE master
GO
...
-- Login: gescooper
CREATE LOGIN [gescooper] WITH PASSWORD = 0x0100C4BFE3A684E571EB68C195ECA41406E131374D73E439F292 HASHED, SID = 0xAB7475E57741BF47B1C3F8B45C2333F6, DEFAULT_DATABASE = [GesCooper90], CHECK_POLICY = ON, CHECK_EXPIRATION = OFF
 
-- Login: consulta
CREATE LOGIN [consulta] WITH PASSWORD = 0x0100BA0923E7051861B40026917A4D02D88F323A449E6CDC0D41 HASHED, SID = 0x2A4D3CAB98D32941BA64370F5C06973F, DEFAULT_DATABASE = [GesCooper90], CHECK_POLICY = ON, CHECK_EXPIRATION = OFF
...
-- Login: rhcravil
CREATE LOGIN [rhcravil] WITH PASSWORD = 0x010029CCDEBE4D158BED24FA9C1B71AF7E62F2651A3CDA39F247 HASHED, SID = 0xB29AA6CBC18B954FBA0739A7D2DDA00E, DEFAULT_DATABASE = [rhcravil], CHECK_POLICY = ON, CHECK_EXPIRATION = OFF
 
-- Login: CRAVIL\administrator
CREATE LOGIN [CRAVIL\administrator] FROM WINDOWS WITH DEFAULT_DATABASE = [master]
 
-- Login: CRAVIL\GescooperERP
CREATE LOGIN [CRAVIL\GescooperERP] FROM WINDOWS WITH DEFAULT_DATABASE = [GesCooper90]
...
-- Login: agrosystem
CREATE LOGIN [agrosystem] WITH PASSWORD = 0x01006662583E116ECC08CB5AA795EE0D56C27C00AC50D2A3CBD6 HASHED, SID = 0xCA9F5559E34A4948A3CC39E9F6EB3EA6, DEFAULT_DATABASE = [CooperSystem], CHECK_POLICY = ON, CHECK_EXPIRATION = OFF
 
-- Login: infneimar
CREATE LOGIN [infneimar] WITH PASSWORD = 0x01007A0440EFCE5C82BF484EBD785183C85146AAF869E0A715EC HASHED, SID = 0xA21CDDE48A95124BA0DF5C9C5A1CB033, DEFAULT_DATABASE = [GesCooper90], CHECK_POLICY = ON, CHECK_EXPIRATION = OFF
