...
SET @dataFim    = '20171231' 
			...
			as(
	            select 									
					...
					, m.NfOpeEstCod														as [Opera��o]
					, op.OpeEstNom														as [Nome Opera��o]
				...
				select 
				convert(varchar(30),t2.[Data Emiss�o], 103) as [Data]				
				, t2.[NF-e]
				, t2.Opera��o
				, t2.[Nome Opera��o]
				,  ROW_NUMBER() over (order by t2.[Data Emiss�o]) as Contagem
				, '' [Status]
				from cte as t2
				where t2.rn < 2	
				order by t2.[Data Emiss�o]
				offset 300 rows
