/*
    OBJETIVO: Identificar as top 100 consultas adhoc com maior consumo de I/O por execução,
              auxiliando na análise de queries que impactam desempenho por leituras excessivas
              em disco e memória.
