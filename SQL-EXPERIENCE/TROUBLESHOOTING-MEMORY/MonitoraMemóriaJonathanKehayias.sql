/*
    OBJETIVO: Monitorar o uso de memória do Buffer Pool por banco de dados e capturar eventos
              de monitoramento de recursos do SQL Server para análise de disponibilidade de memória.
...
SELECT
    CASE WHEN ([is_modified] = 1)
        ...
        ELSE 'Clean-Está na memória e no disco'
    END                                                                                 AS [Status_Páginas_Dados]
