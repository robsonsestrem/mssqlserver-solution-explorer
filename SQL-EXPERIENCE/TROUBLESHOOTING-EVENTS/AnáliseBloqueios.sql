...
, ExtraiXML AS(
	   ...
	   --No banco de dados SQL Server m�ximo por inst�ncias podem ser criados s�o 32.767 
	   --Este �ltimo n�mero foi reservado pelo pr�prio Banco de Dados de Recursos.
	   --Ele � localizado em -> C:\Program Files\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Binn
	   --Nome dele � mssqlsystemresource
