/*
 *
	OBJETIVO: Procedure de auditoria completa de permissões de usuários no SQL Server,
			  verificando associações usuário/login, roles de banco de dados, permissões
			  a nível de database, roles de servidor e permissões a nível de servidor,
			  com suporte a filtros por usuário, database, objeto e tipo de permissão.
	PROJETO: mssqlserver-solution-explorer
	
	REFERÊNCIAS DE URL:
 *	https://dirceuresende.com/blog/verificando-permissoes-privilegios-acessos-um-usuario-database-no-sql-server/
 */
-- ============================================================
