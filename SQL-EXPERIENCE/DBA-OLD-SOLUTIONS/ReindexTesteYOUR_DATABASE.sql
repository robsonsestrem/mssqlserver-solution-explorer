...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Se voc� usar o ALTER INDEX REBUILD passando um �ndice ele s� atualiza as estatisticas deste �ndice
...
and t1.AllocUnitTypeDesc = 'IN_ROW_DATA'
and t1.IndexLevel = 0
order by t1.PageCount desc -- buscando os maiores �ndices por 1�
