	...
	BEGIN TRY
		BEGIN TRANSACTION
			...
			<table border=0 cellpadding=0 cellspacing=0 width=402 style=border-collapse: collapse;table-layout:fixed;width:1000pt;font-family:Arial;font-size:16px>
			  ...
			  <td height=20 colspan=7 style=height:20.0pt;text-align:center>Resumo das Informa��es</td>
			  </tr>
			</table> '
			Set @des_MensagemHTML = @des_MensagemHTML + '
			...
			<td width=650 style=height:20.0pt;>Descri��o</td>
			...
			SET @subject = 'CheckList Di�rio - Log de erros SQL Server';
