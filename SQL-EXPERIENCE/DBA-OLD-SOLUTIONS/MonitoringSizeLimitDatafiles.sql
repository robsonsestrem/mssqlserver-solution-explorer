/*
 *
    OBJETIVO: Procedure para monitoramento do espaço utilizado em datafiles
              em relação ao limite máximo configurado (max_size), alertando
              quando o percentual de uso atinge o valor limite (padrão 95%).
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- ============================================================
        -- Atualização dos campos calculados (espaço livre e percentual de uso)
        -- ============================================================
        UPDATE A
        SET
            A.free_space_GB =
        ...
        -- ============================================================
        -- Cálculo do número de vezes que o crescimento ocorrerá até o limite
        -- ============================================================
        UPDATE A
        SET
            A.growth_times =
        ...
        -- ============================================================
        -- Filtragem dos datafiles que atingiram o limite de uso configurado
        -- ============================================================
        ...
        -- ============================================================
        -- Verifica se existem datafiles críticos e envia e-mail
        -- ============================================================
        ...
        BEGIN
            ...
            -- ============================================================
            DECLARE @Assunto      VARCHAR(200) = @@SERVERNAME + ' - Monitoramento de Espaço de limite Proposto nos Datafiles'
            ...
            arquivo de dados tem em relação ao limite proposto. Alerta configurado para ' + CAST(@Vl_Limite AS VARCHAR(10)) + '%<br><br>

            <TABLE border=1 cellpadding=2 cellspacing=0 style=border-collapse: collapse;table-layout:fixed;width:1210pt;font-family:Arial;font-size:14px>
