-----------------------------------------------------------------------------------------------------------------------------------------------------------
-- Linha de tend�ncia mostrar� aumento nos totais di�rios e semanal de processos bloqueados, indica e justifica baixa de performance.
-----------------------------------------------------------------------------------------------------------------------------------------------------------
--SELECT
...
and h.DateBlock between '2017-03-24' and GETDATE()  -- a data setada � a primerira registrada na rotina de coleta
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
-- No script abaixo foi calculado para trazer a data, por�m � escolhido a �ltima data do agrupamento de count por base de dados,
...
set @limite = (select DATEDIFF(WEEK, '2017-03-24', GETDATE()) * -1)  -- a data setada � a primerira registrada na rotina de coleta
set @decremento = 1
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
select 
x.DateBlock as [Data de Refer�ncia]
