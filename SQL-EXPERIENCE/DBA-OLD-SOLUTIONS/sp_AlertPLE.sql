			...
			begin
			   ...
			   @idealCalculado AS [ideal_calculado]
				...
				AND [counter_name] = 'Page life expectancy'
					...
					SET @CorpoEmail = '
											...
											<tr height=20  style=color:black;>
												<td width=300 style=height:20.0pt><b>Data:</b> '+convert(varchar(30),getdate(),113)+'	
													<br>									
													<br><b>Descri��o:</b> O contador de desempenho do SQL Server <b>''Page Life Expectancy''</b> do objeto ''Buffer Manager'' est� abaixo do ideal de '+cast(@idealCalculado as varchar(10))+', valor atual � de '+cast(@contadorDmv as varchar(20))+'.
													<br>
													<br><b>Obs.:</b> Esse contador nos diz o tempo em segundos que uma p�gina de mem�ria fica no cache. 
													<br>Quanto maior esse tempo, maior � a chance do SQL Server encontrar a informa��o que precisa e assim economizar uma busca no disco.								 																			
												</td>
											</tr>
											</table>
											<br><br>																																				
					...
					-- envia e-mail
					--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
					SET @assuntoEmail = 'Server - '+@@SERVERNAME+' - Evid�ncias de Performance no SQL Server (PLE)'
