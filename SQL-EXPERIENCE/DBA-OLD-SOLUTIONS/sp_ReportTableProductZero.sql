...
BEGIN 
	...
	BEGIN TRY
		BEGIN TRANSACTION
			set @buscaZero = (select count(p.ProCod) from YOUR_DATABASE.dbo.PRODUTOSLEVEL4 as p where p.ProCodPreco = 0)
			IF(@buscaZero > 0)
				BEGIN
					SET @CorpoEmail = '
											...
											<tr height=20  style=color:black;>
												<td width=300 style=height:20.0pt>Data de movimento: '+convert(varchar(12),getdate(),105)+'										
													<br>A��o necess�ria: Deletar este(s) registro(s) com c�digo zero da tabela PRODUTOSLEVEL4.
													<br>Sistema apresentou zero no c�digo de filial para pre�o, segue o(s) iten(s) abaixo:									 																			
												</td>
											</tr>
											</table>
											<br><br>
											...
											<tr height=20  style=height:20.0pt align = center>
												<td bgcolor=#0B0B61 width=200> <font color=white>C�digo Produto</td>
												<td bgcolor=#0B0B61 width=200> <font color=white>C�digo Filial_Pre�o</td>
												<td bgcolor=#0B0B61 width=200> <font color=white>Data Inicio</td>
												<td bgcolor=#0B0B61 width=200> <font color=white>Data Final</td>
												<td bgcolor=#0B0B61 width=200> <font color=white>Data Altera��o</td>
												<td bgcolor=#0B0B61 width=200> <font color=white>Pre�o</td>
											</tr>
										  ';
					...
					-- envia e-mail
					--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
					SET @assuntoEmail = 'Inconsist�ncia Sist�mica - C�digo Zero de Filial para Pre�o'
