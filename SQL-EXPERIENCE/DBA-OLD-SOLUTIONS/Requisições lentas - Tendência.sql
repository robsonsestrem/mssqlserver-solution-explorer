...
-------------------------------------------------------------------------------------------------------------------------------------
-- Para as tarefas  ## usu�rio guru aqui � tratado s� como servi�o (muito ruim de tratar j� que � default das databases guru5 e 6)
-- e o objetivo � direcionado mais para YOUR_DATABASE90
-------------------------------------------------------------------------------------------------------------------------------------
declare @Dt_Inicial datetime = '20180101'
	   ,@Dt_Final datetime = getdate()
select 
