...
as
begin 
	DECLARE @vSubject NVARCHAR(255) = 'Rela��o de dados RH CRAVIL'
	...
	SET @vBody = '<table border=0 cellpadding=0 cellspacing=0 width=402 style=border-collapse: collapse;table-layout:fixed;width:1000pt;font-family:Arial;font-size:12px>
														<tr height=20  style=color:black;>
															<td width=300 style=height:20.0pt>Anexo dados para exporta��o do cadastro de participantes SESCOOP.																																								
																							<br>Data de Extra��o: '+CONVERT(VARCHAR(12),GETDATE(),103)+'																						
															</td>
														</tr>
														</table>
														<br><br>								
