/*
 *
    OBJETIVO: Procedure para geração e envio de relatório diário de erros e avisos
              do SQL Server Error Log das últimas 24 horas, filtrando entradas
              relevantes para monitoramento.
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- ============================================================
        -- Criação da tabela temporária para armazenar o log de erros
        -- ============================================================
        ...
        -- ============================================================
        -- Leitura do Error Log atual via xp_readerrorlog
        -- ============================================================
        ...
        -- ============================================================
        -- Filtragem de entradas relevantes (erros, avisos, etc.)
        -- ============================================================
        DELETE [#ERRORLOG]
        WHERE
        ...
        -- ============================================================
        -- Remove entradas nulas ou com mais de 24 horas
        -- ============================================================
        DELETE [#ERRORLOG]
        ...
        -- ============================================================
        -- Montagem da tabela HTML com os dados filtrados
        -- ============================================================
        SELECT @des_MensagemHTML = @des_MensagemHTML +
               CASE
                   WHEN CAST(ROW_NUMBER() OVER(ORDER BY [EntryTime] DESC) % 2 AS BIT) = 1
