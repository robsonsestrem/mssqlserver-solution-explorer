DECLARE   @diasRetroagir INT = -15	-- Informar dias retroativos para ver diferen�a de fragmenta��o
	    , @dataFiltro DATETIME
...
AS (
	...
	order by 1, 2, 3, 4, 9	-- assim vai juntar melhor os �ndices conforme fragmenta��o por data
