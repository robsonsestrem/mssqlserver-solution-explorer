/*
    OBJETIVO: Identificar índices ausentes (missing indexes) recomendados
              pelo otimizador de consultas do SQL Server, extraindo
              informações do cache de planos como impacto estimado,
              colunas de igualdade, desigualdade e inclusão.
    PROJETO: mssqlserver-solution-explorer

    REFERÊNCIAS:
    https://dirceuresende.com/blog/sql-server-como-identificar-todos-os-indices-ausentes-missing-indexes-de-um-banco-de-dados/
*/
...
-- Remover vírgula final das listas
UPDATE
    #MissingIndexInfo
SET
