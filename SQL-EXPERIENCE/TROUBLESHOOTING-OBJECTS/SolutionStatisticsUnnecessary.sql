/*
 *
    OBJETIVO: Script para identificar estatísticas sobrepostas e desnecessárias
              no SQL Server, especificamente estatísticas de coluna única
              que são cobertas por estatísticas de índice existentes
              (compartilham a mesma coluna à esquerda), gerando comandos
              T-SQL para removê-las.
 ...
 */
-- ============================================================
-- Script para identificar estatísticas sobrepostas
-- ============================================================
