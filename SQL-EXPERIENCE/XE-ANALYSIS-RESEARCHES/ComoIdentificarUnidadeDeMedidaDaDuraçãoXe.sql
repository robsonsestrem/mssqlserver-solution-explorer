--------------------------------------------------------------------------------------------------------------
-- https://tsql.tech/how-to-identify-the-unit-of-measure-of-extended-events-durations/
--------------------------------------------------------------------------------------------------------------
...
WHERE  [o].[object_type] = 'event'
       AND [c].[name] = 'writes'; -- duration | physical_reads | writes | cpu_time | signal_duration